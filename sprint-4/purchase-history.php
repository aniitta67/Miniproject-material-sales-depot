...
$date=date('Y-m-d');
    if(isset($_GET['date']))
    {
      $sql="SELECT a.*,b.item_name,b.cgst,b.sgst,c.category from ordertab as a,material_det as b,category as c where a.matid=b.matid and b.category_id=c.category_id and a.customer_id=$cid and a.date='$_GET[date]'";
     echo "<script>document.getElementById('dat').value='.$_GET[date].'</script>";
    }
    else{
      $sql="SELECT a.*,b.item_name,b.cgst,b.sgst,c.category from ordertab as a,material_det as b,category as c where a.matid=b.matid and b.category_id=c.category_id and a.customer_id=$cid";
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="col-md-6 form-group">
                <h3>SELECT DATE : <input id="dat" type="date" name="date" value="<?php if(isset($_GET['date'])){echo $_GET['date'];}?>" onchange="Load()"></h3>
                </div>
                
<script>
function Load(){
  window.location="bill.php?date="+document.getElementById('dat').value;
}
  </script>
